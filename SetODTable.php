...
<link rel="stylesheet" type="text/css" href="stylesheets/setodtable.css">
...
<div class="container-fluid text-center" Style="background-color: #4b6da3; color: white; padding-top: 15px; padding-bottom: 15px; width: 100%; ">
    <h1>Select requirements for journey calculation</h1>
</div>
<ul >
...
<!-- Page title and navigation -->
        ...
        <form action="JourneyCalc.php" method="post">
            ...
            <br>
                <table style="width:100%" class="paleBlueRows">
                    <tr>
                        ...
                        <th>Road Network Build Date</th>
                        <th>Age Groups included</th>
                        <th>Date and Time Generated</th>
                        <th>Select</th>
                    </tr>
                <?php foreach ($ODtables as $key=>$table):?>
                <?php list($facilityType1,$facilityType2,$demandType1,$demandType2, $demandType3, $CatchmentSize) = explode('_', $table);?>
                    <tr >
                        ...
                        <td ><input type="radio" name="selectedtable" value='<?php echo $table ?>' >
                    </tr>
                <?php endforeach; ?>
                </table>
            </div>
